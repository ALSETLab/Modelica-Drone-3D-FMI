...
Passes a Real signal through without modification.  Enables signals to be read out of one bus, have their name changed and be sent back to a bus.
    ...
    model RealExtend "Pass a Real signal through without modification"
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,
            ...
            Line(points={{-80,0}}, color={81,255,0}),
            Line(points={{-80,0},{0,60},{100,60}}, color={28,108,200}),
            Line(points={{-80,0},{100,0},{100,-60},{0,-60},{-80,0}}, color={28,
                  108,200})}),
                        Documentation(info="<html>
<p>
Passes a Real signal through without modification.  Enables signals to be read out of one bus, have their name changed and be sent back to a bus.
    ...
    model RealExtract "Pass a Real signal through without modification"
...
Passes a Real signal through without modification.  Enables signals to be read out of one bus, have their name changed and be sent back to a bus.
    ...
    model RealDer "Pass a Real signal through without modification"
...
</html>"), Icon(graphics={Rectangle(extent={{-100,100},{100,-100}}, lineColor={
                  28,108,200}), Text(
              extent={{-82,50},{78,-118}},
              lineColor={28,108,200},
              textString="Sum
")}));
    ...
    model simplePID
      ...
      Modelica.Blocks.Math.Gain Dgain(k=kd)
        annotation (Placement(transformation(extent={{18,-10},{38,10}})));
      Modelica.Blocks.Math.Gain Igain(k=ki)
        annotation (Placement(transformation(extent={{18,-70},{38,-50}})));
      Modelica.Blocks.Math.Gain Pgain(k=kp)
      ...
      Tools.RealDer realDer
        annotation (Placement(transformation(extent={{-24,-8},{-8,8}})));
      Tools.SISO sISO
        annotation (Placement(transformation(extent={{62,-10},{82,10}})));
    equation
      connect(Igain.u, integrator.y)
        annotation (Line(points={{16,-60},{-19,-60}}, color={0,0,127}));
      connect(integrator.u, feedback.y) annotation (Line(points={{-42,-60},{-56,
              -60},{-56,0},{-61,0}},
                                color={0,0,127}));
      connect(feedback.y, Pgain.u) annotation (Line(points={{-61,0},{-56,0},{
              -56,60},{16,60}},
                        color={0,0,127}));
      connect(feedback.u1, u)
        annotation (Line(points={{-78,0},{-100,0}}, color={0,0,127}));
      connect(u1, feedback.u2)
        annotation (Line(points={{0,-100},{-70,-100},{-70,-8}}, color={0,0,127}));
      connect(feedback.y, realDer.u)
        annotation (Line(points={{-61,0},{-24,0}}, color={0,0,127}));
      connect(Dgain.u, realDer.y)
        annotation (Line(points={{16,0},{-7.2,0}}, color={0,0,127}));
      connect(sISO.y, y)
        annotation (Line(points={{83,0},{110,0}}, color={0,0,127}));
      connect(Pgain.y, sISO.u2) annotation (Line(points={{39,60},{50,60},{50,4},
              {60,4}}, color={0,0,127}));
      connect(Igain.y, sISO.u1) annotation (Line(points={{39,-60},{50,-60},{50,
              -4.2},{60,-4.2}}, color={0,0,127}));
      connect(Dgain.y, sISO.u)
        annotation (Line(points={{39,0},{60,0}}, color={0,0,127}));
...
")}),                                                                Diagram(
    ...
    model forceZeroLock
      ...
      Modelica.Blocks.Interfaces.RealOutput y
        annotation (Placement(transformation(extent={{100,-10},{120,10}})));
    equation
      y=if u<0 then 0 else u;
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Rectangle(extent={{-100,100},{100,-100}}, lineColor={28,108,200}),
            Line(points={{-78,0},{96,0}}, color={28,108,200}),
            Line(points={{0,-68},{0,90}}, color={28,108,200}),
            Line(points={{-74,-52}}, color={28,108,200}),
            Line(points={{-80,-80},{0,0}}, color={255,0,0}),
            Line(points={{0,0}}, color={255,0,0}),
            Line(points={{0,0},{80,80}}, color={81,255,0})}),        Diagram(
            coordinateSystem(preserveAspectRatio=false)));
    end forceZeroLock;
...
")}), Diagram(coordinateSystem(preserveAspectRatio=false)));
    ...
    model DCmotor
      type motorConstance = Real(quantity = "torque constance", unit = "Nm/A", min=0);
      type aeroFriction = Real(quantity = "propeller friction", unit = "Nms", min=0);
      type propellerConstance = Real(quantity = "propeller constance", unit = "Ns", min=0);

      parameter Modelica.SIunits.Inertia Jp = 0.002 "propeller inertia";
      parameter motorConstance Kt = 2 "motor current to torque constance";
      parameter aeroFriction bp = 0.004 "propeller friction force";
      parameter propellerConstance Kf= 0.01 "propeller constance";
...
"),         Text(
    ...
    model propellerRev
      ...
      Modelica.Blocks.Math.Gain gain(k=-0.004) annotation (Placement(
            ...
            rotation=270,
            origin={40,10})));
      Tools.RealExtract realExtract annotation (Placement(transformation(
            extent={{-6,-6},{6,6}},
            rotation=270,
            origin={40,40})));
      Tools.RealExtend realExtend2 annotation (Placement(transformation(
            extent={{-6,-6},{6,6}},
            rotation=270,
            origin={40,-10})));
      Modelica.Blocks.Math.Gain gain1(k=-1)
        annotation (Placement(transformation(extent={{-30,-78},{-10,-58}})));
      Tools.RealExtend realExtend
        annotation (Placement(transformation(extent={{-28,-42},{-18,-32}})));
      DroneSimulation.Tools.forceZeroLock forceZeroLock
    ...
    equation
      ...
      connect(gain.y, realExtend2.u)
        annotation (Line(points={{40,3.4},{40,-4}}, color={0,0,127}));
      ...
      connect(gain1.y, realExtend1.u)
        annotation (Line(points={{-9,-68},{38,-68}}, color={0,0,127}));
      connect(dCmotor.force, gain1.u) annotation (Line(points={{-53,-54},{-44,
              -54},{-44,-68},{-32,-68}}, color={0,0,127}));
      ...
      connect(dCmotor.torque, realExtend.u) annotation (Line(points={{-53,-46},
              {-40,-46},{-40,-37},{-28,-37}}, color={0,0,127}));
      connect(dCmotor.current, forceZeroLock.y)
        annotation (Line(points={{-74,-50},{-73,-50}}, color={0,0,127}));
      connect(forceZeroLock.u, current) annotation (Line(points={{-94,-50},{-94,
    ...
    equation
      ...
      connect(realExtend.y, force.force) annotation (Line(points={{-17.5,-37},{
              -14,-37},{-14,-22}}, color={0,0,127}));
      connect(dCmotor.force, realExtend1.u) annotation (Line(points={{-53,-54},
              {-50,-54},{-50,-68},{-44,-68}}, color={0,0,127}));
      connect(realExtend1.y, torque.torque) annotation (Line(points={{-23,-68},
              {80,-68},{80,54},{8,54},{8,34}}, color={0,0,127}));
      connect(relativeAngularVelocity.frame_a, force.frame_b) annotation (Line(
          points={{30,84},{-38,84},{-38,0},{-14,0},{-14,8.88178e-16}},
          color={95,95,95},
          thickness=0.5));
      ...
      connect(dCmotor.current, forceZeroLock.y)
        annotation (Line(points={{-74,-50},{-73,-50}}, color={0,0,127}));
      connect(forceZeroLock.u, current) annotation (Line(points={{-94,-50},{-96,
              -50},{-96,0},{-100,0}}, color={0,0,127}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Rectangle(extent={{-100,100},{100,-100}}, lineColor={28,108,200}),
              Text(
              extent={{-72,22},{76,-20}},
              lineColor={28,108,200},
              textString="propeller")}), Diagram(coordinateSystem(
              preserveAspectRatio=false)));
    end propeller;
    ...
    model controlModule
      ...
      Modelica.Blocks.Interfaces.RealInput Height annotation (Placement(
            ...
            rotation=90,
            origin={60,-80})));
      Tools.discretePID discretePID(
        ki=1,
        kd=0.8,
        kp=1.5,
        samplePeriod=samplePeriod)
        annotation (Placement(transformation(extent={{-38,-40},{-18,-20}})));
      Tools.RealExtract realExtract(index=1)
        annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
      Modelica.Blocks.Interfaces.RealInput position[3]
        annotation (Placement(transformation(extent={{-120,-20},{-80,20}})));
      Tools.RealExtract realExtract1(index=2)
        annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
      Tools.RealExtract realExtract2(index=3)
        annotation (Placement(transformation(extent={{-80,-40},{-60,-20}})));
      Tools.discretePID discretePID1(
        kp=0.1,
        kd=0.1,
        samplePeriod=samplePeriod,
        ki=0.03)
        annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
      Tools.discretePID discretePID2(
        kd=1,
        kp=1,
        samplePeriod=samplePeriod,
        ki=0.3)
              annotation (Placement(transformation(extent={{44,20},{64,40}})));
      Tools.RealExtract realExtract3(index=2) annotation (Placement(
            transformation(
            extent={{-4,-4},{4,4}},
            rotation=0,
            origin={14,-72})));
      Tools.RealExtract realExtract4(index=2)
      ...
      Tools.RealExtract realExtract5
        annotation (Placement(transformation(extent={{-44,-76},{-36,-68}})));
      Tools.discretePID discretePID3(
        kd=0.1,
        kp=0.1,
        samplePeriod=samplePeriod,
        ki=0.03)
      ...
      Tools.RealExtract realExtract6(index=1)
      ...
      Tools.discretePID discretePID4(
        kd=1,
        kp=1,
        samplePeriod=samplePeriod,
        ki=0.1)
              annotation (Placement(transformation(extent={{32,-10},{52,10}})));
      Tools.RealExtract realExtract7(index=1) annotation (Placement(
            transformation(
            extent={{-4,-4},{4,4}},
            rotation=0,
            origin={14,-60})));
      Tools.RealExtract realExtract8(index=3) annotation (Placement(
            transformation(
            extent={{-4,-4},{4,4}},
            rotation=90,
            origin={-28,58})));
      Tools.discretePID discretePID5(
        kd=0.08,
        kp=0.04,
        ki=0,
        samplePeriod=samplePeriod)
    ...
    equation
      connect(position, realExtract.u) annotation (Line(points={{-100,0},{-90,0},
              {-90,30},{-80,30}}, color={0,0,127}));
      connect(position, realExtract1.u)
        annotation (Line(points={{-100,0},{-80,0}}, color={0,0,127}));
      connect(position, realExtract2.u) annotation (Line(points={{-100,0},{-90,
              0},{-90,-30},{-80,-30}}, color={0,0,127}));
      ...
      connect(yaw, discretePID5.u)
        annotation (Line(points={{-100,80},{-38,80}}, color={0,0,127}));
    ...
    equation
      ...
      connect(product.y, add2.u1) annotation (Line(points={{9,34},{14,34},{14,
              -12},{-18,-12},{-18,-30},{-6,-30}}, color={0,0,127}));
      ...
      connect(add2.y, firstOrder3.u)
        annotation (Line(points={{17,-36},{28,-36}}, color={0,0,127}));
      connect(firstOrder3.y, y1) annotation (Line(points={{51,-36},{60,-36},{60,
              -40},{110,-40}}, color={0,0,127}));
      annotation (Icon(graphics={Text(
              extent={{-78,52},{80,-50}},
              lineColor={28,108,200},
              textString="CirclePath
"), Rectangle(extent={{-100,100},{100,-100}}, lineColor={28,108,200})}));
    end circlePath;
  ...
  package Tests
    model motorTest
      ...
      Module.propellerRev propellerRev1
    ...
    equation
      ...
      connect(feedback.y, dCmotor.current)
        annotation (Line(points={{-39,8},{-10,8}}, color={0,0,127}));
      connect(propeller1.current, feedback.y) annotation (Line(points={{-10,-34},
              {-24,-34},{-24,8},{-39,8}}, color={0,0,127}));
      connect(step1.y, feedback.u2) annotation (Line(points={{-55,-36},{-48,-36},
              {-48,0}}, color={0,0,127}));
      connect(propellerRev1.current, dCmotor.current) annotation (Line(points={
              {-10,-66},{-24,-66},{-24,8},{-10,8}}, color={0,0,127}));
    ...
    model chassisTest
      ...
      Module.droneChassis droneChassis1
        annotation (Placement(transformation(extent={{30,-10},{80,10}})));
      Module.propeller propeller3
      ...
      Module.propellerRev propellerRev2
    ...
    equation
      ...
      connect(propellerRev1.current, propeller1.current) annotation (Line(
            points={{-20,20},{-30,20},{-30,50},{-20,50}}, color={0,0,127}));
      connect(feedback.y, gain.u)
        annotation (Line(points={{-56.8,8},{-50.8,8}}, color={0,0,127}));
      connect(gain.y, propeller3.current) annotation (Line(points={{-41.6,8},{
              -30,8},{-30,-20},{-20,-20}}, color={0,0,127}));
      connect(propellerRev1.current, propeller3.current) annotation (Line(
            points={{-20,20},{-30,20},{-30,-20},{-20,-20}}, color={0,0,127}));
      connect(propellerRev2.current, gain.y) annotation (Line(points={{-20,-60},
    ...
    model simpleHoverTest
      Module.propeller propeller1
        annotation (Placement(transformation(extent={{-20,40},{0,60}})));
      Module.droneChassis droneChassis1(m=10)
        annotation (Placement(transformation(extent={{30,-10},{80,10}})));
      Module.propeller propeller3
        annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));
      inner Modelica.Mechanics.MultiBody.World world(n(displayUnit="1") = {0,0,
      ...
      DroneSimulation.Tools.simplePID simplePID(
        kd=0.8,
        ki=1,
        kp=1.5)
    ...
    equation
      ...
      connect(propellerRev1.frame_a, droneChassis1.frame_a) annotation (Line(
          ...
          thickness=0.5));
      connect(propellerRev1.current, propeller1.current) annotation (Line(
            points={{-20,20},{-42,20},{-42,50},{-20,50}}, color={0,0,127}));
      connect(propellerRev1.current, propeller3.current) annotation (Line(
            points={{-20,20},{-42,20},{-42,-20},{-20,-20}}, color={0,0,127}));
      connect(relativePosition.frame_b, droneChassis1.frame_a3) annotation (
          Line(
      ...
      connect(ramp.y, simplePID.u)
        annotation (Line(points={{-95,-2},{-86,-2}}, color={0,0,127}));
      connect(realExtract.y, simplePID.u1)
        annotation (Line(points={{-76,-29},{-76,-12}}, color={0,0,127}));
      connect(propellerRev1.current, simplePID.y) annotation (Line(points={{-20,
              20},{-42,20},{-42,-2},{-65,-2}}, color={0,0,127}));
      connect(propellerRev2.current, simplePID.y) annotation (Line(points={{-20,
              -60},{-42,-60},{-42,-2},{-65,-2}}, color={0,0,127}));
    ...
    equation
      connect(forceZeroLock.u, sine.y)
        annotation (Line(points={{-10,0},{-23,0}}, color={0,0,127}));
      connect(sine.y, limiter.u) annotation (Line(points={{-23,0},{-18,0},{-18,
    ...
    model propellerTest
      ...
      Tools.RealDer realDer
        annotation (Placement(transformation(extent={{-154,-50},{-138,-34}})));
      Modelica.Blocks.Math.Gain gain1(k=5)
        annotation (Placement(transformation(extent={{-124,-52},{-104,-32}})));
      Modelica.Blocks.Continuous.Integrator integrator
        annotation (Placement(transformation(extent={{-152,-82},{-132,-62}})));
      Modelica.Blocks.Math.Gain gain2(k=10)
        annotation (Placement(transformation(extent={{-122,-82},{-102,-62}})));
      Tools.SISO sISO
    ...
    equation
      ...
      connect(feedback.u2, realExtract.y) annotation (Line(points={{-166,40},{
              -162,40},{-162,-115},{-156.7,-115}}, color={0,0,127}));
      connect(realDer.y, gain1.u)
        annotation (Line(points={{-137.2,-42},{-126,-42}}, color={0,0,127}));
      connect(integrator.y, gain2.u)
        annotation (Line(points={{-131,-72},{-124,-72}}, color={0,0,127}));
      connect(gain.y, sISO.u2) annotation (Line(points={{-125,48},{-104,48},{
              -104,-10},{-86,-10}},
                               color={0,0,127}));
      connect(gain1.y, sISO.u) annotation (Line(points={{-103,-42},{-92,-42},{
              -92,-14},{-86,-14}},
                               color={0,0,127}));
      connect(gain2.y, sISO.u1) annotation (Line(points={{-101,-72},{-92,-72},{
              -92,-18.2},{-86,-18.2}}, color={0,0,127}));
      connect(realExtend.u, sISO.y) annotation (Line(points={{-78,56},{-68,56},
              {-68,-14},{-63,-14}},color={0,0,127}));
      connect(realDer.u, feedback.y) annotation (Line(points={{-154,-42},{-157,
              -42},{-157,48}}, color={0,0,127}));
      connect(integrator.u, feedback.y) annotation (Line(points={{-154,-72},{-156,
              -72},{-156,48},{-157,48}}, color={0,0,127}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{
    ...
    equation
      ...
      connect(propellerRev1.frame_a, droneChassis1.frame_a) annotation (Line(
          ...
          thickness=0.5));
      connect(propellerRev1.current, propeller1.current) annotation (Line(
            points={{-20,40},{-42,40},{-42,70},{-20,70}}, color={0,0,127}));
      connect(propellerRev1.current, propeller3.current) annotation (Line(
            points={{-20,40},{-42,40},{-42,0},{-20,0}},     color={0,0,127}));
      connect(relativePosition.frame_b, droneChassis1.frame_a3) annotation (
          Line(
      ...
      connect(discretePID.y, propeller3.current) annotation (Line(points={{-65,18},
              {-42,18},{-42,0},{-20,0}},         color={0,0,127}));
      connect(propellerRev2.current, discretePID.y) annotation (Line(points={{-20,-40},
              {-42,-40},{-42,18},{-65,18}},          color={0,0,127}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{
    ...
    model controlModuleTest
      Module.controlModule controlModule(maxTilt=0.05, samplePeriod=0.01)
        annotation (Placement(transformation(extent={{-30,8},{-10,28}})));
      Module.droneChassis droneChassis1(length=0.25, m=0.5)
      ...
      inner Modelica.Mechanics.MultiBody.World world(n(displayUnit="1") = {0,0,
          -1})
        annotation (Placement(transformation(extent={{60,60},{80,80}})));
      Tools.RealExtendMultiple realExtendMultiple
        annotation (Placement(transformation(extent={{-58,8},{-38,28}})));
      Modelica.Blocks.Sources.Ramp ramp(          duration=0.5, height=5)
        annotation (Placement(transformation(extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-80,-50})));
      Module.sensors.GPS gPS annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={18,-40})));
      Module.sensors.Accelerometer accelerometer
    ...
    equation
      ...
      connect(propellerRev1.frame_a, droneChassis1.frame_a) annotation (Line(
          ...
          color={95,95,95},
          thickness=0.5));
      connect(propeller1.current, controlModule.y1) annotation (Line(points={{8,46},{
              -2,46},{-2,24},{-9,24}},      color={0,0,127}));
      connect(propellerRev1.current, controlModule.y) annotation (Line(points={{8,26},{
              0,26},{0,20},{-9,20}},         color={0,0,127}));
      connect(propeller3.current, controlModule.y2) annotation (Line(points={{8,6},{0,
              6},{0,16},{-9,16}},         color={0,0,127}));
      connect(propellerRev2.current, controlModule.y3) annotation (Line(points={{8,-14},
              {-2,-14},{-2,12},{-9,12}},        color={0,0,127}));
      connect(controlModule.position, realExtendMultiple.y) annotation (Line(
            points={{-30,18},{-37,18}},                   color={0,0,127}));
      connect(gPS.frame_a, droneChassis1.frame_a3) annotation (Line(
          points={{28,-40},{36,-40},{36,10},{44,10}},
          color={95,95,95},
          thickness=0.5));
      connect(gPS.y, controlModule.GPS) annotation (Line(points={{7,-40},{-26,
              -40},{-26,10}}, color={0,0,127}));
      ...
      connect(accelerometer.y, controlModule.Gyero) annotation (Line(points={{7,-66},
              {-20,-66},{-20,10}},      color={0,0,127}));
      connect(ramp.y, firstOrder1.u)
        annotation (Line(points={{-80,-39},{-80,-32}},   color={0,0,127}));
      connect(controlModule.yaw, const.y) annotation (Line(points={{-30,26},{
    ...
    equation
      ...
      connect(propellerRev1.frame_a, droneChassis1.frame_a) annotation (Line(
          ...
          color={95,95,95},
          thickness=0.5));
      connect(propeller1.current, controlModule.y1) annotation (Line(points={{8,30},{
              -2,30},{-2,6},{-9,6}},        color={0,0,127}));
      connect(propellerRev1.current, controlModule.y) annotation (Line(points={{8,8},{0,
              8},{0,2},{-9,2}},              color={0,0,127}));
      connect(propeller3.current, controlModule.y2) annotation (Line(points={{8,-12},
              {0,-12},{0,-2},{-9,-2}},    color={0,0,127}));
      connect(propellerRev2.current, controlModule.y3) annotation (Line(points={{8,-32},
              {-2,-32},{-2,-6},{-9,-6}},        color={0,0,127}));
      connect(controlModule.position, realExtendMultiple.y) annotation (Line(
            points={{-30,0},{-37,0}},                     color={0,0,127}));
      connect(gPS.frame_a, droneChassis1.frame_a3) annotation (Line(
          points={{28,-58},{36,-58},{36,-8},{44,-8}},
          color={95,95,95},
          thickness=0.5));
      connect(gPS.y, controlModule.GPS) annotation (Line(points={{7,-58},{-26,-58},{
              -26,-8}},       color={0,0,127}));
      connect(accelerometer.frame_a, droneChassis1.frame_a3) annotation (Line(
      ...
      connect(accelerometer.y, controlModule.Gyero) annotation (Line(points={{7,-84},
              {-20,-84},{-20,-8}},      color={0,0,127}));
      connect(controlModule.yaw, const.y) annotation (Line(points={{-30,8},{-36,8},{
              -36,15},{-36,15}},           color={0,0,127}));
    ...
    model controlModuleTest_fmu_main
      controlModuleTest_fmu_inputs controlModuleTest_fmu_inputs1
        annotation (Placement(transformation(extent={{-20,-14},{30,34}})));
    ...
    equation
      connect(const.y, controlModuleTest_fmu_inputs1.xcoord) annotation (Line(
            points={{-45,28},{-30,28},{-30,29.2},{-25,29.2}},   color={0,0,127}));
      connect(controlModuleTest_fmu_inputs1.ycoord,
        controlModuleTest_fmu_inputs1.xcoord) annotation (Line(points={{-25,10},
              {-40,10},{-40,28},{-30,28},{-30,29.2},{-25,29.2}},       color={0,
              0,127}));
      connect(ramp.y, controlModuleTest_fmu_inputs1.zcoord) annotation (Line(
            points={{-45,-8},{-34,-8},{-34,-9.2},{-25,-9.2}},   color={0,0,127}));
