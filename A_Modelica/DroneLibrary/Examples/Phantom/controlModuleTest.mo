...
equation
   connect(propeller_1_1.position, controlModuleSpeed.y1) annotation (Line(
         points={{5.8,32.4},{-2,32.4},{-2,24},{-9.09091,24}},
                                                    color={0,0,127}));
...
connect(propeller_1_4.position, controlModuleSpeed.y3) annotation (Line(
      points={{5.8,2.4},{-2.1,2.4},{-2.1,12},{-9.09091,12}}, color={0,0,127}));
connect(propeller_1_3.position, controlModuleSpeed.y2) annotation (Line(
      points={{5.8,12.4},{-1.1,12.4},{-1.1,16},{-9.09091,16}}, color={0,0,127}));
connect(controlModuleSpeed.y, propeller_1_2.position) annotation (Line(points={{-9.09091,20},{-2,20},{-2,22.4},{5.8,22.4}},
                                                     color={0,0,127}));
