...
<p>The user can create their own drone models using the <b>Drone_Template</b>, which provides a standard template to interface the drone with any of the test cases.</p>
</html>"));
end Examples;
