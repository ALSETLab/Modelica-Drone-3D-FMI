...
model ModuleTest_Dymola
  ...
  DroneWithIdealPower.Drone_IdealMachine_SynchronousPID
    ...
    annotation (Placement(transformation(extent={{20,-16},{48,12}})));
  DroneLibrary.Visualization.Inputs.Keyboard.KeyboardInputs_Dymola keyboardInputs_Dymola annotation (Placement(transformation(extent={{-46,-22},{-6,18}})));
equation
