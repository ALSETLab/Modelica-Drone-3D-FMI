...
model Drone_Visualize "Model to use for animation and visualization."
  ...
  Mechanical.Chassis.Variants.droneChassis_Visualize droneChassis_Visualization(length=0.25, m=0.5) annotation (Placement(transformation(extent={{44,-12},{94,8}})));
  Mechanical.Propeller.Variants.DCMachine_Visualize propeller_DCMachine_Visualization(PropellerGain=1) annotation (Placement(transformation(extent={{10,12},{30,20}})));
