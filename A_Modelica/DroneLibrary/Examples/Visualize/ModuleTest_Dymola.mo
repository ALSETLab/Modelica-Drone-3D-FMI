...
model ModuleTest_Dymola
  ...
  replaceable DroneLibrary.Visualize.Inputs.Keyboard.KeyboardInputs_SimVis inputDevice constrainedby Interfaces.InputDevice_Dymola annotation (Placement(transformation(extent={{-28,-10},{-8,10}})));
