...
model ModuleTest_SimVis
  ...
  Visualize.Shapes.FileShape shape(
    ...
    color={0,0,0}) annotation (Placement(transformation(extent={{38,-36},{58,-16}})));
  ...
  replaceable DroneLibrary.Visualize.Inputs.Keyboard.KeyboardInputs_SimVis inputDevice_SimVis constrainedby Interfaces.InputDevice_SimVis annotation (Placement(transformation(extent={{-32,-10},{-12,10}})));
