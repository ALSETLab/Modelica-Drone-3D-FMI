...
model DroneTest_FMU_Synchronous
  ...
  Mechanical.Chassis.Variants.MavicAir mavicAir_droneChassis(length=0.25, m=0.5) annotation (Placement(transformation(extent={{44,-12},{94,8}})));
  Mechanical.Propeller.Variants.MavicAir mavicAir_propeller annotation (Placement(transformation(extent={{10,12},{30,20}})));
...
equation
  ...
  connect(mavicAir_propeller3.Airframe, mavicAir_droneChassis.frame_a3)
    annotation (Line(
      points={{30.2,-15.6},{37.1,-15.6},{37.1,-8},{44,-8}},
      color={95,95,95},
      thickness=0.5));
  connect(mavicAir_droneChassis.frame_a2, mavicAir_propeller2.Airframe)
    annotation (Line(
      points={{44,-4},{38,-4},{38,-5.6},{30.2,-5.6}},
      color={95,95,95},
      thickness=0.5));
  connect(mavicAir_propeller1.Airframe, mavicAir_droneChassis.frame_a)
    annotation (Line(
      points={{30.2,4.4},{37.1,4.4},{37.1,0},{44,0}},
      color={95,95,95},
      thickness=0.5));
  connect(mavicAir_droneChassis.frame_a1, mavicAir_propeller.Airframe)
    annotation (Line(
