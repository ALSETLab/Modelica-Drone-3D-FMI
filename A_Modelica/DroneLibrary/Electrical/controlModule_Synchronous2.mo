...
model controlModule_Synchronous2
...
equation
  ...
  connect(limiter.y, discreteTF5.u) annotation (Line(points={{21,30},{34,30}},
                                   color={0,0,127}));
  connect(limiter1.y, discreteTF6.u) annotation (Line(points={{21,-4},{28,-4}},
                                    color={0,0,127}));
  connect(discreteTF6.u1, realExtract7.y) annotation (Line(points={{38,-14},{38,
  ...
  connect(add3_3.y, y2)
    annotation (Line(points={{108.6,-20},{130,-20}}, color={0,0,127}));
  connect(realExtract8.u, Gyero) annotation (Line(points={{-26,56},{-26,50},{-12,50},{-12,-70},{0,-70},{0,-100}}, color={0,0,127}));
...
end controlModule_Synchronous2;
