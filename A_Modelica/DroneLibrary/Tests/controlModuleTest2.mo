...
equation
  ...
  connect(circlePath.y1, realExtendMultiple.u1) annotation (Line(points={{
   ...
   connect(propellerRev1.position, controlModule.y) annotation (Line(points={{5.8,
          27.2},{-0.1,27.2},{-0.1,20},{-9.16667,20}},color={0,0,127}));
   ...
   connect(propellerRev2.Airframe, droneChassis1.frame_a2) annotation (Line(
       ...
       color={95,95,95},
       thickness=0.5));
   connect(propellerRev2.position, controlModule.y2) annotation (Line(points={{5.8,
          17.2},{-9.16667,17.2},{-9.16667,16}},
                                          color={0,0,127}));
