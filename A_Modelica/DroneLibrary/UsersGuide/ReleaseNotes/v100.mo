within DroneLibrary.UsersGuide.ReleaseNotes;
class v100 "Version 1.0.0 (2023-06-09)"
   extends Modelica.Icons.ReleaseNotes;
  annotation (Documentation(info="<html>
<h4>What&apos;s Changed</h4>
<p>This version of <code>DroneLibrary</code> is the initial release. </p>
<h5>Highlights</h5>
<ul>
<li>Multi-domain library with components to construct a quadcopter model.</li>
<li>Example cases to simulate different quadcopter variants using an XYZ coordinate input command.</li>
