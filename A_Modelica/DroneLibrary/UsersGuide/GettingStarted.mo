...
and ramp the height of the drone up to 5m in the z-direction using the input <b>zcoord_ramp</b>. 
...
<code>DroneLibrary/Resources/Scripts/drone_animation_setup.mos</code> script.
 Then the following animation appears and can be interacted with using the inputs supplied in <b>xcoord</b>, <b>ycoord</b>, and <b>zcoord</b>.</p>
