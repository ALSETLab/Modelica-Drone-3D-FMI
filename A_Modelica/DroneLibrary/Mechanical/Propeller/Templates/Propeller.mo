within DroneLibrary.Mechanical.Propeller.Templates;
partial model Propeller
  replaceable DroneLibrary.Mechanical.Motor.Templates.DCMotor DCMotor(k=PropellerGain) annotation (Placement(transformation(extent={{-80,-20},{-40,20}})));
  Modelica.Blocks.Interfaces.RealInput position
    annotation (Placement(transformation(extent={{-142,-20},{-102,20}})));
  replaceable DroneLibrary.Mechanical.Rotor.Templates.rotor rotor1 annotation (Placement(transformation(extent={{-16,20},{26,-20}})));
