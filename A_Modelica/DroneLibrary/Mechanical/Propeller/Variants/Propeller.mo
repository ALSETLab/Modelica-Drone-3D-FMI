...
model Propeller
  ...
  Rotor.Variants.rotor rotor3_1(k=PropellerGain) annotation (Placement(transformation(extent={{-16,20},{26,-20}})));
  Modelica.Mechanics.MultiBody.Interfaces.Frame_a Airframe
    annotation (Placement(transformation(extent={{86,-26},{118,6}})));
  Blades.Variants.Blades blades(animation=animation)
...
equation
  ...
  connect(rotor3_1.Blade, blades.Input) annotation (Line(
      ...
      color={95,95,95},
      thickness=0.5));
  connect(rotor3_1.torque_2, dCMotor.torque_1) annotation (Line(
      points={{-16.42,0},{-40,0}},
      color={95,95,95},
      thickness=0.5));
  connect(dCMotor.torque_2,rotor3_1. torque_1) annotation (Line(
      points={{-40,-12},{-16.42,-12}},
      color={95,95,95},
      thickness=0.5));
  connect(rotor3_1.force, dCMotor.force_out) annotation (Line(
