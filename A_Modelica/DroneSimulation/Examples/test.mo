...
model test
  ...
  Modelica.Blocks.Sources.Constant const4(k=0)
    annotation (Placement(transformation(extent={{-102,-98},{-90,-86}})));
  ...
  Mechanical.Propeller.Propeller_DCMachine_Power propeller_DCMachine_Power4(
      PropellerGain=1, V=5)
  ...
  Mechanical.Propeller.Propeller_DCMachine_Power propeller_DCMachine_Power5(V=5)
    annotation (Placement(transformation(extent={{-24,-94},{-4,-84}})));
  Mechanical.Propeller.Propeller_DCMachine_Power propeller_DCMachine_Power6(
      PropellerGain=1, V=5)
    annotation (Placement(transformation(extent={{-24,-108},{-4,-98}})));
  Mechanical.Propeller.Propeller_DCMachine_Power propeller_DCMachine_Power7(V=5)
...
equation
  ...
  connect(accelerometer.y, controlModule.Gyero) annotation (Line(points={{-13,
          -40},{-49.6667,-40},{-49.6667,24}}, color={0,0,127}));
  ...
  connect(gPS.frame_a, propeller_DCMachine_Power.Airframe) annotation (Line(
      points={{8,-18},{32,-18},{32,54},{20,54},{20,55},{12.2,55}},
      color={95,95,95},
      thickness=0.5));
  connect(ramp.y, realExtendMultiple.u2) annotation (Line(points={{-145,-36},{
          -134,-36},{-134,-28},{-122,-28}}, color={0,0,127}));
  connect(realExtendMultiple.y, controlModule.position) annotation (Line(points
        ={{-101,-22},{-74,-22},{-74,36},{-59.6667,36}}, color={0,0,127}));
  ...
  connect(propeller_DCMachine_Power4.position, controlModule1.y1) annotation (
      Line(points={{-26,-78},{-40,-78},{-40,-90},{-53.1667,-90}}, color={0,0,
          127}));
  ...
  connect(propeller_DCMachine_Power5.position, controlModule1.y) annotation (
      Line(points={{-26,-92},{-40,-92},{-40,-94},{-53.1667,-94}}, color={0,0,
          127}));
  connect(propeller_DCMachine_Power5.p1, propeller_DCMachine_Power4.p1)
    annotation (Line(points={{-24.4,-86},{-30,-86},{-30,-72},{-24.4,-72}},
        color={0,0,255}));
  connect(propeller_DCMachine_Power6.position, controlModule1.y2) annotation (
      Line(points={{-26,-106},{-40,-106},{-40,-98},{-53.1667,-98}}, color={0,0,
          127}));
  connect(controlModule1.y3, propeller_DCMachine_Power7.position) annotation (
      Line(points={{-53.1667,-102},{-40,-102},{-40,-120},{-26,-120}}, color={0,
          0,127}));
  connect(propeller_DCMachine_Power7.p1, propeller_DCMachine_Power4.p1)
    annotation (Line(points={{-24.4,-114},{-32,-114},{-32,-86},{-30,-86},{-30,
          -72},{-24.4,-72}}, color={0,0,255}));
  connect(propeller_DCMachine_Power6.p1, propeller_DCMachine_Power4.p1)
    annotation (Line(points={{-24.4,-100},{-32,-100},{-32,-86},{-30,-86},{-30,
          -72},{-24.4,-72}}, color={0,0,255}));
  connect(gPS1.frame_a, propeller_DCMachine_Power4.Airframe) annotation (Line(
      points={{-8,-150},{16,-150},{16,-78},{4,-78},{4,-77},{-3.8,-77}},
      color={95,95,95},
      thickness=0.5));
