...
model controlModuleTest_fmu_main
  ...
  DroneTest_FMU droneTest_FMU(V=10)
...
equation
  connect(const.y, droneTest_FMU.xcoord) annotation (Line(points={{-45,28},{-28,
          28},{-28,29},{-23,29}}, color={0,0,127}));
  connect(droneTest_FMU.ycoord, droneTest_FMU.xcoord) annotation (Line(points={
          {-23,9},{-36,9},{-36,28},{-28,28},{-28,29},{-23,29}}, color={0,0,127}));
  ...
  connect(droneTest_FMU.zcoord, add.u1) annotation (Line(points={{-23,-11},{-56,
          0},{-54,0},{-54,-10},{-49,-10}}, color={0,0,127}));
