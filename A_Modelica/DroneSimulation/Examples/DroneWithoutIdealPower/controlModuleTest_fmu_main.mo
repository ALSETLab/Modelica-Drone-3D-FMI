...
model controlModuleTest_fmu_main
  ...
  DroneTest_FMU_Constant_Voltage            droneTest_FMU_Constant_Voltage1(V=10)
...
equation
  ...
  connect(droneTest_FMU_Constant_Voltage1.xcoord, const.y) annotation (Line(
        points={{-23.8,42.4},{-34.8,42.4},{-34.8,28},{-45,28}}, color={0,0,127}));
  connect(droneTest_FMU_Constant_Voltage1.ycoord, const.y) annotation (Line(
        points={{-23.8,20},{-34,20},{-34,28},{-45,28}}, color={0,0,127}));
  connect(droneTest_FMU_Constant_Voltage1.zcoord, add.u1) annotation (Line(
        points={{-23.8,-2.4},{-54,-2.4},{-54,-10},{-49,-10}}, color={0,0,127}));
