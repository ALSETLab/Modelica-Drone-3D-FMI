...
model controlModuleTest_fmu_main
  ...
  DroneTest_FMU_DCmotor
                droneTest_FMU_DCmotor(V=10, R=1)
...
equation
  connect(const.y, droneTest_FMU_DCmotor.xcoord) annotation (Line(points={{-45,28},
          {-28,28},{-28,29},{-23,29}},     color={0,0,127}));
  ...
  connect(droneTest_FMU_DCmotor.zcoord, add.u1) annotation (Line(points={{-23,-11},
          {-56,-11},{-56,-10},{-49,-10}},       color={0,0,127}));
