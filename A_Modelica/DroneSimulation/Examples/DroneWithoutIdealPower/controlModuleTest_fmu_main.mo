...
model controlModuleTest_fmu_main
  ...
  DroneTest_FMU_Battery2 drone(V=12.1, animation=false)
    annotation (Placement(transformation(extent={{-2,-60},{88,50}})));
equation


  connect(ramp1.y, add.u1) annotation (Line(points={{-61,0},{-54,0},{-54,-10},{
          -49,-10}},
                 color={0,0,127}));
  ...
  connect(drone.zcoord, add.u1) annotation (Line(points={{-11,-49},{-54,0},{-54,
