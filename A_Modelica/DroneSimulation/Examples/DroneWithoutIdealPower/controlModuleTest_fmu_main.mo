...
model controlModuleTest_fmu_main
  ...
  DroneTest_FMU_Battery                     droneTest_FMU_Battery(         V=12.1)
...
equation
  ...
  connect(add.u2, uniformNoise.y) annotation (Line(points={{-51,-14},{-51,-32},
          {-59,-32}},      color={0,0,127}));
  connect(droneTest_FMU_Battery.xcoord, const.y) annotation (Line(points={{
          -23.2727,42.4},{-34.8,42.4},{-34.8,28},{-45,28}}, color={0,0,127}));
  connect(droneTest_FMU_Battery.ycoord, const.y) annotation (Line(points={{
          -23.2727,20},{-34,20},{-34,28},{-45,28}}, color={0,0,127}));
  connect(droneTest_FMU_Battery.zcoord, ramp.y) annotation (Line(points={{
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-80,
    ...
    experiment(StopTime=45, Tolerance=0.01),
