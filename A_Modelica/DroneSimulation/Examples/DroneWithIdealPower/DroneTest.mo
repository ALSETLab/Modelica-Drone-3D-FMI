...
model DroneTest
  ...
  Tests.controlModuleTest_fmu_inputs2 controlModuleTest_fmu_inputs2_1
...
equation
   ...
   connect(controlModuleTest_fmu_inputs2_1.ycoord,
     controlModuleTest_fmu_inputs2_1.xcoord) annotation (Line(points={{-23,9},
