...
model DCMotor_DCMachine2 "DC motor using DC machine from MSL"
  ...
  VeSyMA.ElectricMotors.TableBased.AC350Nm aC350Nm
    annotation (Placement(transformation(extent={{-72,-36},{-52,-16}})));
  Claytex.Mechanics.Rotation3D.Adapters.ToRotational toRotationalConversion
    annotation (Placement(transformation(extent={{-46,-34},{-42,-18}})));
...
equation
  ...
  connect(aC350Nm.pin_n, signalVoltage.n)
    annotation (Line(points={{-68,-16},{-68,-10}}, color={0,0,255}));
  connect(signalVoltage.p, aC350Nm.pin_p)
    annotation (Line(points={{-56,-10},{-56,-16}}, color={0,0,255}));
  ...
  connect(aC350Nm.shaft_b, toRotationalConversion.flange_a) annotation (Line(
      points={{-52,-26},{-46,-26}},
      color={135,135,135},
      thickness=0.5));
  connect(toRotationalConversion.flange_b, torqueSensor.flange_a) annotation (
      Line(points={{-42,-26},{-40,-26},{-40,-38},{-40,-38}}, color={0,0,0}));
