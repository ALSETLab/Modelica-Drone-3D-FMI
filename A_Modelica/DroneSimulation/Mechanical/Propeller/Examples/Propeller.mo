...
equation
  ...
  connect(rotor2_1.Blade, blades.Input) annotation (Line(
      ...
      color={95,95,95},
      thickness=0.5));
  connect(rotor2_1.torque_2, dCMotor.torque_1) annotation (Line(
      points={{-16.42,0},{-40,0}},
      color={95,95,95},
      thickness=0.5));
  connect(dCMotor.torque_2, rotor2_1.torque_1) annotation (Line(
      points={{-40,-12},{-16.42,-12}},
      color={95,95,95},
      thickness=0.5));
  connect(rotor2_1.force, dCMotor.force_out) annotation (Line(
