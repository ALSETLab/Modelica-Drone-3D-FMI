...
model DroneTest
  ...
  DroneTest_FMU_VISUALIZATON          droneTest_FMU_VISUALIZATON
...
equation
  connect(const.y, droneTest_FMU_VISUALIZATON.xcoord) annotation (Line(points={
          {-45,28},{-28,28},{-28,29},{-23,29}}, color={0,0,127}));
  connect(droneTest_FMU_VISUALIZATON.ycoord, droneTest_FMU_VISUALIZATON.xcoord)
  ...
  connect(droneTest_FMU_VISUALIZATON.zcoord, droneTest_FMU_VISUALIZATON.xcoord)
    annotation (Line(points={{-23,-11},{-36,10},{-36,28},{-28,28},{-28,29},{-23,
          29}}, color={0,0,127}));
